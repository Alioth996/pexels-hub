...
const typeEnum = {
  primary:
    'text-white  bg-blue-700 dark:bg-zinc-900  hover:bg-blue-600 dark:hover:bg-zinc-700 active:bg-blue-800 dark:active:bg-zinc-700',
...
const props = defineProps({
  ...
  size: {
    ...
    default: 'default',
    validator(val) {
      // 获取所有的可选的大小（注意剔除 icon 元素，因为期望使用者输入 size="default"，但不期望开发者输入 size="icon-default"）
